      ...
      <div className="bg-gradient-to-br from-green-50 to-orange-50 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-gray-600 max-w-3xl mx-auto">
            Get in touch with us for inquiries, partnerships, or to learn more about our products and services.
          </p>
        </div>
      </div>
            ...
            <div className="space-y-8">
              <div>
                ...
                <p className="text-gray-600 text-lg mb-8">
                  We're here to help you with all your fruit pulp and concentrate needs. 
                  Reach out to us for quotes, partnerships, or any questions.
                </p>
              </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-600">
                      #171, 1st Floor, MTH Road, Villivakkam,<br />
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">Visit our head office in Chennai, Tamil Nadu</p>
          </div>
